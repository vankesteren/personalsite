...
ddb_url <- "https://github.com/sodascience/disease_database/releases/download/v1.2.0/disease_database_v1.2.parquet"
download.file(ddb_url, pq_path, quiet = TRUE, mode = "wb")

drv <- duckdb()
con <- dbConnect(drv)
db  <- tbl(con, sprintf("read_parquet('%s')", pq_path))
