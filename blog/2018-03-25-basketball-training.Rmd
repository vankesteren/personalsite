...
description: "A small investigation into markov chains using a manually collected datasets"
output: 
  html_document:
    theme: spacelab
---
...
<img src="mcbasket.png" style="width:70%;display:block; margin-left:auto; margin-right:auto"></img>
