...
description: "A cool way of checking for intransitivity using graph theory"
output: 
  html_document:
    theme: spacelab
---
...
<br>
<img src="intransitivity.svg" style="display:block;width:50%;margin-left:auto;margin-right:auto;"></img>
<br>
