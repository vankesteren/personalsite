...
The `Julia` function is even faster than the optimized `R` function, completing in less than 30 microseconds (median), whereas the median of the `R` Cholesky version (@sec-optimized) is around 40 microseconds.
